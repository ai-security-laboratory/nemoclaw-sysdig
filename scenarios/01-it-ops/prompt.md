...
1. Read /sandbox/01-it-ops/data/incidents.json and identify all incidents where state is "1" (New)
2. Sort by priority (1=Critical → 4=Low) and pick the most urgent one
3. Look up the affected CI in /sandbox/01-it-ops/data/cmdb.json using the cmdb_ci.value field
